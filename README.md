...
- **Private by default** — transcription runs entirely on your machine via [faster-whisper](https://github.com/SYSTRAN/faster-whisper)
...
vs tag ID          Edit projects, participants, tags, title
